...
public class AgeValidator implements Validator<Integer> {
    ...
    public void validate(FacesContext context, UIComponent component, Integer value) throws ValidatorException {
        ...
        if (value == null || value == 0 ) {
            ...
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Age can not be 0",null));
        }
     
           if (value< 18 || value> 100) {
                msg.setSummary("Age must be between 18 and 100!");
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Age must be between 18 and 100!",null));    
    }
